...
namespace Customweb\BarclaycardCw\Plugin\Sales\Model;
...
class Order
{
	...
	public function afterCanFetchPaymentReviewUpdate(\Magento\Sales\Model\Order $subject, $result)
	{
		...
		if ($subject->getPayment() instanceof \Magento\Sales\Model\Order\Payment
	    	&& $subject->getPayment()->getMethodInstance() instanceof \Customweb\BarclaycardCw\Model\Payment\Method\AbstractMethod
			&& $this->_coreRegistry->registry('barclaycardcw_order_view')) {
