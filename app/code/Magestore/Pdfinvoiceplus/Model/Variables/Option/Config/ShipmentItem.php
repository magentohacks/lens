 ...
 */
class ShipmentItem extends \Magestore\Pdfinvoiceplus\Model\Variables\Option\AbstractVariableConfig
{
    ...
    {
        return self::XML_PATH_VARIABLES_SHIPMENT_ITEM;
    }
    ...
    {
        return $this->_optionManager->get(OptionManager::OPTION_VARIABLE_SHIPMENT_ITEM);
    }
}