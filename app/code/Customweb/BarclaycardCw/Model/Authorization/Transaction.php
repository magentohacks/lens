...
namespace Customweb\BarclaycardCw\Model\Authorization;

use \Customweb\BarclaycardCw\Api\Data\TransactionInterface;

/**
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setEntityId(int $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setTransactionExternalId(string $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setOrderId(int $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setOrderIncrementId(string $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setOrderPaymentId(int $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setAliasForDisplay(string $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setAliasActive(boolean $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setPaymentMethod(string $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setTransactionObject(\Customweb_Payment_Authorization_ITransaction $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setAuthorizationType(string $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setCustomerId(int $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setUpdatedOn(string $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setCreatedOn(string $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setPaymentId(string $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setExecuteUpdateOn(string $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setAuthorizationAmount(float $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setAuthorizationStatus(string $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setPaid(boolean $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setLiveTransaction(boolean $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setCurrency(string $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setSendEmail(boolean $value)
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setStoreId(int $value)
 * @method int getVersionNumber()
 * @method \Customweb\BarclaycardCw\Model\Authorization\Transaction setVersionNumber(int $value)
 */
class Transaction extends \Magento\Framework\Model\AbstractModel implements \Magento\Sales\Model\EntityInterface, TransactionInterface
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_barclaycardcw_transaction';
	 ...
	 * @var string
	 */
	protected $_entityType = 'barclaycardcw_trx';
	...
	/**
	 * @var \Customweb\BarclaycardCw\Model\Authorization\Method\Factory
	 */
	protected $_authorizationMethodFactory;

	/**
	 * @var \Customweb\BarclaycardCw\Model\Alias\Handler
	 */
	 ...
	 * @param \Customweb\BarclaycardCw\Model\Authorization\Method\Factory $authorizationMethodFactory
	 * @param \Customweb\BarclaycardCw\Model\Alias\Handler $aliasHandler
	...
	public function __construct(
			...
			\Customweb\BarclaycardCw\Model\Authorization\Method\Factory $authorizationMethodFactory,
			\Customweb\BarclaycardCw\Model\Alias\Handler $aliasHandler,
	...
	{
		$this->_init('Customweb\BarclaycardCw\Model\ResourceModel\Authorization\Transaction');
	}
	...
	public function afterSave()
	{
		...
		if ($this->getTransactionObject() !== null && $this->getTransactionObject() instanceof \Customweb_Payment_Authorization_ITransaction) {
			...
			if ($customerContext instanceof \Customweb\BarclaycardCw\Model\Authorization\CustomerContext) {
				try {
		...
		if ($this->_registry->registry('initializeTransaction') !== false && $this->getTransactionObject() == null) {
			...
			/* @var $adapter \Customweb\BarclaycardCw\Model\Authorization\Method\AbstractMethod */
	 ...
	 * @return \Customweb\BarclaycardCw\Model\Authorization\Transaction
	 */
