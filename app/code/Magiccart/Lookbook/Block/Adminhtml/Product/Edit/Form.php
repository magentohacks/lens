    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('link', 'text',
            [
                ...
                <p class="nm"><small>Ex1: https://instagram.com</small></p>
                <p class="nm"><small>Ex2: lookbook</small></p>
            ',
            ]
        );

        $fieldset->addField('preview', 'text',
            [
                'label' => __('Preview'),
                'title' => __('Preview'),
                'name'  => 'preview',
                'required' => false,
                'after_element_html' => '
                <p class="nm"><small>Preview for Lookbook:</small></p>
                <p class="nm"><small>Ex1: https://domain.com/preview.png</small></p>
                <p class="nm"><small>Ex2: https://domain.com/video.mp4</small></p>
            ',
            ]
        );
        ...
        $content = $fieldset->addField('description', 'editor',
            [
