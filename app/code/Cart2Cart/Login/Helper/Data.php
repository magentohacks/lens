...
class Data
{
   ...
   * @return bool|mixed
   */
  public function passwordIsValid($store, $version, $hash, $password, $salt)
  {
    $className = "Cart2Cart\\Login\\Helper\\Encryption\\$store$version";
    $validator = $this->objectManager->create($className);

    return call_user_func([$validator, 'validatePassword'], $hash, $password, (string)$salt);
  }
}