...
class Widget extends \Customweb\BarclaycardCw\Controller\Checkout
{
	public function execute()
	{
		$context = $this->_authorizationMethodFactory->getContextFactory()->createTransaction();
		/* @var $authorizationMethodAdapter \Customweb\BarclaycardCw\Model\Authorization\Method\Widget */
		...
		$resultPage->getLayout()
			->getBlock('customweb_barclaycardcwcheckout_widget')
