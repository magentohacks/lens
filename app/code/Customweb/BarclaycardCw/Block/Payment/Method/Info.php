...
class Info extends \Magento\Payment\Block\Info
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_BarclaycardCw::payment/method/info.phtml';
	...
	public function getMethod()
	{
		...
		if ($this->getTransaction() instanceof \Customweb\BarclaycardCw\Model\Authorization\Transaction) {
	...
	{
		return $this->getUrl('barclaycardcw/transaction/view', ['transaction_id' => $this->getTransaction()->getId()]);
	}
