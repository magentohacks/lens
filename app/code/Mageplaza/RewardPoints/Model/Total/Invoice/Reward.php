...
class Reward extends AbstractTotal
{
    ...
    public function collect(Invoice $invoice)
    {
        ...
        $itemInvoice         = $this->calculation->getOldRewardData($order->getInvoiceCollection(), $fields, $addShippingDiscount);
     ...
     */
    public function calculateRewardDiscount($invoice, $orderItem, $item, $itemInvoice, &$totalDiscountAmount, &$baseTotalDiscountAmount)
    {
