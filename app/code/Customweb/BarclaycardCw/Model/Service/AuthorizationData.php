...
class AuthorizationData implements \Customweb\BarclaycardCw\Api\Data\AuthorizationDataInterface {
	...
	public function setHiddenFormFields(array $hiddenFormFields)
	{
		...
		foreach ($hiddenFormFields as $key => $value) {
			$field = new \Customweb\BarclaycardCw\Model\Service\AuthorizationFormField();
