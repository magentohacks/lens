...
class Items
{
    ...
    public function getDisplayableItems()
    {
        ...
        if ($this->_config->create()->getSetting('attributes/custom1'))
            $items['custom1'] = ['label' => $this->_config->create()->getSetting('attributes/custom1'),'source' => 'attribute', 'attribute' => $this->_config->create()->getSetting('attributes/custom1'), 'renderer' => 'text'];
        if ($this->_config->create()->getSetting('attributes/custom2'))
            $items['custom2'] = ['label' => $this->_config->create()->getSetting('attributes/custom2'), 'source' => 'attribute', 'attribute' => $this->_config->create()->getSetting('attributes/custom2'), 'renderer' => 'text'];
