...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $table = $installer->getConnection()
            ...
            ->addColumn('stop_rules_processing', Table::TYPE_SMALLINT, null, ['nullable' => false, 'default' => '1',], 'Stop Rules Processing')
            ...
            ->addColumn('discount_style', Table::TYPE_TEXT, 25, ['nullable' => false, 'default' => 'fixed',], 'Discount Style')
            ->addColumn('point_amount', Table::TYPE_INTEGER, 11, ['nullable' => false, 'default' => 0,], 'Point Amount')
            ->addColumn('discount_amount', Table::TYPE_INTEGER, 11, ['nullable' => false, 'default' => 0,], 'Discount Amount')
            ...
            ->addIndex($installer->getIdxName(self::CATALOGRULE_TABLE,
        ...
        $table = $installer->getConnection()
            ...
            ->addColumn('rule_id', Table::TYPE_INTEGER, null, ['unsigned' => true, 'nullable' => false, 'default' => '0'], 'Rule Id')
            ->addColumn('from_time', Table::TYPE_INTEGER, null, ['unsigned' => true, 'nullable' => false, 'default' => '0'], 'From Time')
            ->addColumn('to_time', Table::TYPE_INTEGER, null, ['unsigned' => true, 'nullable' => false, 'default' => '0'], 'To time')
            ->addColumn('customer_group_id', $customerGroupIdType, null, ['unsigned' => true, 'nullable' => false, 'primary' => true, 'default' => '0'], 'Customer Group Id')
            ...
            ->addColumn('point_amount', Table::TYPE_INTEGER, 11, ['nullable' => false, 'default' => '0'], 'Point Amount')
            ->addColumn('discount_amount', Table::TYPE_DECIMAL, [12, 4], ['nullable' => false, 'default' => '0'], 'Discount Amount')
            ->addColumn('action_stop', Table::TYPE_SMALLINT, null, ['nullable' => false, 'default' => '0'], 'Action Stop')
            ->addColumn('sort_order', Table::TYPE_INTEGER, null, ['unsigned' => true, 'nullable' => false, 'default' => '0'], 'Sort Order')
            ->addColumn('website_id', Table::TYPE_SMALLINT, null, ['unsigned' => true, 'nullable' => false], 'Website Id')
            ->addColumn('money_step', Table::TYPE_DECIMAL, [12, 4], ['nullable' => false, 'default' => '0'], 'Point Amount')
            ->addColumn('max_points', Table::TYPE_INTEGER, 11, ['unsigned' => true, 'nullable' => false], 'Max Points')
            ->addIndex($installer->getIdxName(self::CATALOGRULE_PRODUCT_TABLE,
                ['rule_id', 'from_time', 'to_time', 'website_id', 'customer_group_id', 'product_id', 'sort_order'], true),
            ...
            ->addIndex($installer->getIdxName(self::CATALOGRULE_PRODUCT_TABLE, ['customer_group_id']), ['customer_group_id'])
            ...
            ->addForeignKey(
                $installer->getFkName(self::CATALOGRULE_PRODUCT_TABLE, 'product_id', 'catalog_product_entity', 'entity_id'),
                'product_id',
            ...
            ->addForeignKey(
                $installer->getFkName(self::CATALOGRULE_PRODUCT_TABLE, 'customer_group_id', 'customer_group', 'customer_group_id'),
                'customer_group_id',
            ...
            ->addForeignKey(
                $installer->getFkName(self::CATALOGRULE_PRODUCT_TABLE, 'rule_id', self::CATALOGRULE_PRODUCT_TABLE, 'rule_id'),
                'rule_id',
        ...
        /**
         * Maeplaza Reward Catalog Rule Website
         */
        $table = $installer->getConnection()
            ...
            ->addColumn('website_id', Table::TYPE_SMALLINT, null, ['unsigned' => true, 'nullable' => false, 'primary' => true], 'Website Id')
        ...
        $table = $installer->getConnection()
            ...
            ->addColumn('customer_group_id', $customerGroupIdType, null, ['unsigned' => true, 'nullable' => false, 'primary' => true], 'Customer Group Id')
            ->addIndex($installer->getIdxName(self::CATALOGRULE_CUSTOMER_GROUP_TABLE, ['rule_id']), ['rule_id'])
            ->addIndex($installer->getIdxName(self::CATALOGRULE_CUSTOMER_GROUP_TABLE, ['customer_group_id']), ['customer_group_id'])
            ->addForeignKey(
                $installer->getFkName(self::CATALOGRULE_CUSTOMER_GROUP_TABLE, 'rule_id', self::CATALOGRULE_TABLE, 'rule_id'),
                'rule_id',
                $installer->getTable(self::CATALOGRULE_TABLE),
                'rule_id',
                Table::ACTION_CASCADE
            ...
            ->addForeignKey(
                $installer->getFkName(self::CATALOGRULE_CUSTOMER_GROUP_TABLE, 'customer_group_id', 'customer_group', 'customer_group_id'),
                'customer_group_id',
                $installer->getTable('customer_group'),
                'customer_group_id',
                Table::ACTION_CASCADE
        ...
        if (!$installer->tableExists(self::SHOPPING_CART_TABLE)) {
            $table = $installer->getConnection()
                ...
                ->addColumn('rule_type', Table::TYPE_SMALLINT, null, ['nullable' => false, 'default' => '1'], 'Rule Type')
                ->addColumn('name', Table::TYPE_TEXT, 255, [], 'Name')
                ->addColumn('description', Table::TYPE_TEXT, '64k', [], 'Description')
                ->addColumn('from_date', Table::TYPE_DATE, null, [], 'From Date')
                ->addColumn('to_date', Table::TYPE_DATE, null, [], 'To Date')
                ...
                ->addColumn('stop_rules_processing', Table::TYPE_SMALLINT, null, ['nullable' => false, 'default' => '1'], 'Stop Rules Processing')
                ->addColumn('sort_order', Table::TYPE_INTEGER, null, ['unsigned' => true, 'nullable' => false, 'default' => '0'], 'Sort Order')
                ->addColumn('is_advanced', Table::TYPE_SMALLINT, null, ['unsigned' => true, 'nullable' => false, 'default' => '1',], 'Is Advanced')
                ...
                ->addColumn('point_amount', Table::TYPE_INTEGER, 11, ['unsigned' => true, 'nullable' => false], 'Point Amount')
                ->addColumn('money_step', Table::TYPE_INTEGER, 11, ['unsigned' => true, 'nullable' => false], 'Money Step')
                ->addColumn('qty_step', Table::TYPE_INTEGER, 11, ['unsigned' => true, 'nullable' => false], 'Quantity Step')
                ->addColumn('max_points', Table::TYPE_INTEGER, 11, ['unsigned' => true, 'nullable' => false], 'Max Points')
                ->addColumn('discount_style', Table::TYPE_TEXT, 32, ['nullable' => false, 'default' => 'fixed'], 'Discount Style')
                ->addColumn('discount_amount', Table::TYPE_INTEGER, 11, ['nullable' => false, 'default' => '0'], 'Discount Amount')
                ->addIndex($installer->getIdxName(self::SHOPPING_CART_TABLE,
                    ['is_active', 'sort_order', 'to_date', 'from_date']),
                    ['is_active', 'sort_order', 'to_date', 'from_date'])
        ...
        $table = $installer->getConnection()
            ...
            ->addForeignKey(
                $installer->getFkName(self::SHOPPING_CART_WEBSITE_TABLE, 'rule_id', self::SHOPPING_CART_TABLE, 'rule_id'),
                'rule_id',
        ...
        $table = $installer->getConnection()
            ...
            ->addIndex($installer->getIdxName(self::SHOPPING_CART_CUSTOMER_GROUP_TABLE, ['customer_group_id']), ['customer_group_id'])
            ->addForeignKey(
                $installer->getFkName(self::SHOPPING_CART_CUSTOMER_GROUP_TABLE, 'rule_id', self::SHOPPING_CART_TABLE, 'rule_id'),
                'rule_id',
                $installer->getTable(self::SHOPPING_CART_TABLE),
                'rule_id',
                Table::ACTION_CASCADE
            ...
            ->addForeignKey(
                $installer->getFkName(self::SHOPPING_CART_CUSTOMER_GROUP_TABLE, 'customer_group_id', 'customer_group', 'customer_group_id'),
                'customer_group_id',
                $installer->getTable('customer_group'),
                'customer_group_id',
                Table::ACTION_CASCADE
        ...
        $table = $installer->getConnection()
            ...
            ->addIndex(
                $installer->getIdxName('salesrule_label', ['rule_id', 'store_id'], \Magento\Framework\DB\Adapter\AdapterInterface::INDEX_TYPE_UNIQUE),
                ['rule_id', 'store_id'],
