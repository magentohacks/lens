 ...
 * @method \Customweb\BarclaycardCw\Model\Storage setKeySpace(string $value)
 * @method string getKeyName()
 * @method \Customweb\BarclaycardCw\Model\Storage setKeyName(string $value)
 * @method string getKeyValue()
 * @method \Customweb\BarclaycardCw\Model\Storage setKeyValue(string $value)
 */
class Storage extends \Magento\Framework\Model\AbstractModel
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_barclaycardcw_storage';
    ...
    {
        $this->_init('Customweb\BarclaycardCw\Model\ResourceModel\Storage');
    }
