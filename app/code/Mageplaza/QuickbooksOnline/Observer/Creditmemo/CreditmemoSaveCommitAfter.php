...
/**
 * Class CreditmemoSaveCommitAfter
 * @package Mageplaza\QuickbooksOnline\Observer\Creditmemo
 */
class CreditmemoSaveCommitAfter extends AbstractQueue
{
    /**
    ...
    public function executeAction(Observer $observer)
    {
        ...
        if ($dataObject->getIsNewRecord()) {
            $this->helperSync->addObjectToQueue(QuickbooksModule::CREDIT_MEMO, $dataObject);
        }
    }
}
