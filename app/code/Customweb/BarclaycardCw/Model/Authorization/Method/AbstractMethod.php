...
namespace Customweb\BarclaycardCw\Model\Authorization\Method;
...
abstract class AbstractMethod
{
	...
	/**
	 * @var \Customweb\BarclaycardCw\Model\Authorization\TransactionContextFactory
	 */
	...
	/**
	 * @var \Customweb\BarclaycardCw\Model\ResourceModel\Authorization\Transaction\CollectionFactory
	 */
	protected $_transactionCollectionFactory;

	/**
	 * @var \Customweb\BarclaycardCw\Model\Authorization\Method\Context\Factory
	 */
	...
	/**
	 * @var \Customweb\BarclaycardCw\Model\Authorization\Method\Context\IContext
	 */
	private $context;
	 ...
	 * @param \Customweb\BarclaycardCw\Model\Authorization\TransactionContextFactory $transactionContextFactory
	 * @param \Customweb\BarclaycardCw\Model\Authorization\TransactionFactory $transactionFactory
	 * @param \Customweb\BarclaycardCw\Model\ResourceModel\Authorization\Transaction\CollectionFactory $transactionCollectionFactory
	 * @param \Customweb\BarclaycardCw\Model\Authorization\Method\Context\Factory $contextFactory
	 * @param \Customweb\BarclaycardCw\Model\Authorization\Method\Context\IContext $context
	 */
	public function __construct(
			...
			\Customweb\BarclaycardCw\Model\Authorization\TransactionContextFactory $transactionContextFactory,
			\Customweb\BarclaycardCw\Model\Authorization\TransactionFactory $transactionFactory,
			\Customweb\BarclaycardCw\Model\ResourceModel\Authorization\Transaction\CollectionFactory $transactionCollectionFactory,
			\Customweb\BarclaycardCw\Model\Authorization\Method\Context\Factory $contextFactory,
			\Customweb\BarclaycardCw\Model\Authorization\Method\Context\IContext $context
	...
	/**
	 * @return \Customweb\BarclaycardCw\Model\Authorization\Method\Context\IContext
	 */
	public function getContext()
	{
		if (!($this->context instanceof \Customweb\BarclaycardCw\Model\Authorization\Method\Context\IContext)) {
	 ...
	 * @param \Customweb\BarclaycardCw\Model\Authorization\Method\Context\IContext $context
	 */
	public function setContext(\Customweb\BarclaycardCw\Model\Authorization\Method\Context\IContext $context)
	{
		$this->context = $context;
	}
	...
	public function initializeTransaction(\Customweb\BarclaycardCw\Model\Authorization\Transaction $transaction)
	{
		
		$arguments = array(
			'transaction' => $transaction,
 		);
		return \Customweb_Licensing_BarclaycardCw_License::run('2hqsp04ik6tk5163', $this, $arguments);
	}

	final public function call_j2ol6dl76ig1nk01() {
	...
	/**
	 * @return \Customweb\BarclaycardCw\Model\Service\AuthorizationData
	 */
	public function startAuthorization()
	{
		$data = new \Customweb\BarclaycardCw\Model\Service\AuthorizationData();
	...
	public function finishAuthorization()
	{
		...
		$arguments = null;
		return \Customweb_Licensing_BarclaycardCw_License::run('42m0ptvqkgam1j65', $this, $arguments);
	}

	final public function call_n4dbke90004p7nms() {
		$arguments = func_get_args();
		$method = $arguments[0];
		$call = $arguments[1];
		$parameters = array_slice($arguments, 2);
	...
	/**
	 * @return \Customweb\BarclaycardCw\Model\Authorization\Transaction|null
	 */
	...
	{
		if ($this->getContext()->getPaymentMethod() instanceof \Customweb\BarclaycardCw\Model\Payment\Method\AbstractMethod) {
