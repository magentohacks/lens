...
class Earning
{
     ...
     * @return string
     */
    public function aroundGetReviewsSummaryHtml(AbstractProduct $subject, \Closure $proceed, $product, $templateType = false, $displayIfNoReviews = false)
    {
        ...
        if ($this->pointHelper->isEnabled()
            ...
            try {
                ...
                $label      = in_array($product->getTypeId(), ['grouped', 'bundle']) ?
