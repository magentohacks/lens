 ...
 */
class Creditmemo extends \Magestore\Pdfinvoiceplus\Model\Variables\Option\AbstractVariableConfig
{
    /**
     * @return string
     */
    ...
    {
        return self::XML_PATH_VARIABLES_CREDITMEMO;
    }
    ...
    {
        return $this->_optionManager->get(OptionManager::OPTION_VARIABLE_CREDITMEMO);
    }
}