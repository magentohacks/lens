...
namespace Customweb\BarclaycardCw\Block\Adminhtml\Checkout\Payment;

class Form extends \Magento\Backend\Block\Widget
{
	/**
	 * @var \Customweb\BarclaycardCw\Model\Renderer\AdminhtmlForm
	 */
	...
	/**
	 * @var \Customweb\BarclaycardCw\Model\Authorization\Method\AbstractMethod
	 */
	 ...
	 * @param \Customweb\BarclaycardCw\Model\Renderer\Adminhtml\CheckoutForm $formRenderer
	 * @param \Customweb\BarclaycardCw\Model\Authorization\Method\Factory $authorizationMethodFactory
	 * @param array $data
	 */
	public function __construct(
			\Magento\Backend\Block\Template\Context $context,
			\Customweb\BarclaycardCw\Model\Renderer\Adminhtml\CheckoutForm $formRenderer,
	...
	{
		if (!($this->authorizationMethodAdapter instanceof \Customweb\BarclaycardCw\Model\Authorization\Method\AbstractMethod)) {
	...
	{
		if (!($this->transaction instanceof \Customweb\BarclaycardCw\Model\Authorization\Transaction)) {
	 ...
	 * @return \Customweb\BarclaycardCw\Block\Adminhtml\Checkout\Payment\Form
	 */
	public function setTransaction(\Customweb\BarclaycardCw\Model\Authorization\Transaction $transaction)
	{
