...
class Transfer extends AbstractPdf {
    ...
    public function getPdf($transfers = [])
    {
        ...
        foreach($transfers as $transfer){
            ...
            $this->_drawCompanyInformation($page);
    ...
    protected function _drawHeader(\Zend_Pdf_Page $page)
    {
        ...
        $lines[0][] = ['text' => __('SKU'), 'feed' => 90, 'align' => 'left'];
        $lines[0][] = ['text' => __('Name'), 'feed' => 150, 'align' => 'left'];
        $lines[0][] = ['text' => __('Barcode'), 'feed' => 280, 'align' => 'left'];
        $lines[0][] = ['text' => __('Location in source'), 'feed' => 430, 'align' => 'right'];
        $lines[0][] = ['text' => __('Location in target'), 'feed' => 550, 'align' => 'right'];
     ...
     * @param \Zend_Pdf_Page $page
     */
    protected function _drawCompanyInformation($page){
        ...
        $this->y -= 15;
        $page->drawText($this->_scopeConfig->getValue('general/store_information/name', \Magento\Store\Model\ScopeInterface::SCOPE_STORE), 30, $this->y, 'UTF-8');
    ...
    protected function _drawItem($item, $page, $transfer){
        ...
        $lines[0][] = ['text' => $item->getproduct_name(), 'feed' => 150, 'align' => 'left'];
        $lines[0][] = ['text' => $item->getBarcode(), 'feed' => 280, 'align' => 'left'];
        $lines[0][] = ['text' => $item->getFromShelfLocation($transfer->getst_from()), 'feed' => 430, 'align' => 'right'];
        $lines[0][] = ['text' => $item->getToShelfLocation($transfer->getst_to()), 'feed' => 550, 'align' => 'right'];
