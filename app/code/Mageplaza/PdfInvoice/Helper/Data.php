...
class Data extends AbstractData
{
     ...
     * @return array|mixed
     */
    public function isEnableEInvoice($storeId = null)
    {
        return $this->getConfigGeneral('e_invoice/enabled', $storeId);
    }
     ...
     * @return array|mixed
     */
    public function getEInvoiceProfile($storeId = null)
    {
        return $this->getConfigGeneral('e_invoice/profile', $storeId);
    }
     ...
     * @return array|mixed
     */
    public function getPaymentTerms($storeId = null)
    {
        return $this->getConfigGeneral('e_invoice/payment_terms', $storeId);
    }
    ...
    {
        $barcodeConfig                      = [];
        $barcodeConfig['size']              = (float) $this->getDesignBarcode('barcode_size',
            $storeId) < 1.6 ? $this->getDesignBarcode('barcode_size', $storeId) : '0.9';
    ...
    {
        $columnCollection = $this->columnCollectionFactory->addFieldToFilter('template_id', $id)->setOrder('position',
            'ASC');
