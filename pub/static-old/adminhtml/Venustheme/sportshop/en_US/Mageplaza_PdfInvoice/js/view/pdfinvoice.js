...
], function ($, modal, $t, confirmation, CodeMirror) {
    "use strict";
        ...
        loadTemplate: function () {
            ...
            $("#load_template").click(function () {
                if ($("#template_styles").val() !== '') {
                    confirmation({
                        title: 'Accept load template',
                        content: 'It looks like you have been adding data. If you click "load template" before saving, your changes will be lost.',
                        actions: {
                            confirm: function () {
