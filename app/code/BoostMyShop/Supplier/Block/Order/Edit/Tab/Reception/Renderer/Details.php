...
class Details extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
     ...
     * @param array $data
     */
    public function __construct(\Magento\Backend\Block\Context $context, \BoostMyShop\Supplier\Model\ResourceModel\Order\Reception\Item\CollectionFactory $collectionFactory,  array $data = [])
    {
    ...
    public function render(DataObject $row)
    {
        ...
        foreach($collection as $item)
            $html[] = $item->getpori_qty().'x '.$item->getpop_sku().' - '.$item->getpop_name();
