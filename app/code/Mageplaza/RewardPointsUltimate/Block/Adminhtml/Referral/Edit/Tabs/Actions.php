...
class Actions extends ActionsForm
{
    ...
    public function addCustomerActions($form, $blockDependence)
    {
        ...
        $blockDependence->addFieldMap($customerAction->getHtmlId(), $customerAction->getName())
            ...
            ->addFieldDependence($customerPoints->getName(), $customerAction->getName(),
            ...
            ->addFieldDependence($customerDiscount->getName(), $customerAction->getName(),
                $this->fieldFactory->create(
                    [
                        'fieldData'   => [
                            'value'     => implode(',', [
    ...
    public function addReferralActions($form, $blockDependence)
    {
        ...
        $blockDependence->addFieldMap($referralsActions->getHtmlId(), $referralsActions->getName())
            ...
            ->addFieldDependence($referralPoints->getName(), $referralsActions->getName(),
                $this->fieldFactory->create(
                    [
                        'fieldData'   => [
                            'value'     => implode(',', [
            ...
            ->addFieldDependence($referralMoneyStep->getName(), $referralsActions->getName(), ReferralActions::TYPE_PRICE);
    }
}