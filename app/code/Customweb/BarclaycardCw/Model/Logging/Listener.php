...
namespace Customweb\BarclaycardCw\Model\Logging;
...
class Listener implements \Customweb_Core_Logger_IListener {
	 ...
	 * @var string
	 */
	protected $fileName = '/var/log/barclaycardcw.log';
	...
	public function __construct(
		...
		$this->_logger = new Logger('barclaycardcw');
	...
	private function isLevelActive($level) {
		switch ($this->_scopeConfig->getValue('barclaycardcw/logging/level')) {
			case 'debug':
				return true;
			case 'info':
