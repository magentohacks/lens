...
namespace Customweb\BarclaycardCw\Model\ExternalCheckout;

/**
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setContextId(string $value)
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setState(string $value)
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setFailedErrorMessage(string $value)
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setCartUrl(string $value)
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setDefaultCheckoutUrl(string $value)
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setInvoiceItems(\Customweb_Payment_Authorization_IInvoiceItem[] $value)
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setOrderAmountInDecimals(double $value)
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setCurrencyCode(string $value)
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setLanguageCode(string $value)
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setCustomerEmailAddress(string $value)
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setCustomerId(int $value)
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setTransactionId(int $value)
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setShippingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setBillingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setShippingMethodName(string $value)
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setPaymentMethod(string $value)
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setProviderData(array $value)
 * @method string getCreatedOn()
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setCreatedOn(string $value)
 * @method string getUpdatedOn()
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setUpdatedOn(string $value)
 * @method string getSecurityToken()
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setSecurityToken(string $value)
 * @method string getSecurityTokenExpiryDate()
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setSecurityTokenExpiryDate(string $value)
 * @method string getAuthenticationSuccessUrl()
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setAuthenticationSuccessUrl(string $value)
 * @method string getAuthenticationEmailAddress()
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setAuthenticationEmailAddress(string $value)
 * @method int getQuoteId()
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setQuoteId(int $value)
 * @method string getRegisterMethod()
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setRegisterMethod(string $value)
 * @method int getStoreId()
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setStoreId(int $value)
 * @method int getVersionNumber()
 * @method \Customweb\BarclaycardCw\Model\ExternalCheckout\Context setVersionNumber(int $value)
 */
class Context extends \Magento\Framework\Model\AbstractModel implements \Customweb_Payment_ExternalCheckout_IContext
{
	...
	/**
	 * @var \Customweb\BarclaycardCw\Helper\InvoiceItem
	 */
	protected $_invoiceItemHelper;

	/**
	 * @var \Customweb\BarclaycardCw\Helper\FoomanSurcharge
	 */
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_barclaycardcw_external_checkout_context';
	...
	/**
	 * @var \Customweb\BarclaycardCw\Model\Payment\Method\AbstractMethod
	 */
	 ...
	 * @param \Customweb\BarclaycardCw\Helper\InvoiceItem $invoiceItemHelper
	 * @param \Customweb\BarclaycardCw\Helper\FoomanSurcharge $foomanSurchargeHelper
	...
	public function __construct(
			...
			\Customweb\BarclaycardCw\Helper\InvoiceItem $invoiceItemHelper,
			\Customweb\BarclaycardCw\Helper\FoomanSurcharge $foomanSurchargeHelper,
    ...
    protected function _construct() {
        $this->_init('Customweb\BarclaycardCw\Model\ResourceModel\ExternalCheckout\Context');
    }
     ...
     *
     * @param int $quoteId
     * @return \Customweb\BarclaycardCw\Model\ExternalCheckout\Context
     */
    ...
    {
    	if (!($this->cachedPaymentMethod instanceof \Customweb\BarclaycardCw\Model\Payment\Method\AbstractMethod)) {
    		try {
    ...
    /**
     * @param string|\Customweb\BarclaycardCw\Model\Payment\Method\AbstractMethod $paymentMethod
     * @return \Customweb\BarclaycardCw\Model\ExternalCheckout\Context
     */
    public function setPaymentMethod($paymentMethod)
    {
    	if ($paymentMethod instanceof \Customweb\BarclaycardCw\Model\Payment\Method\AbstractMethod) {
    ...
    public function updateQuote(\Magento\Quote\Model\Quote $quote = null)
    {
		...
		if ($this->getPaymentMethod() instanceof \Customweb\BarclaycardCw\Model\Payment\Method\AbstractMethod) {
			$data = [
