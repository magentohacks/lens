...
namespace Customweb\BarclaycardCw\Model\Service;

class TransactionRepository implements \Customweb\BarclaycardCw\Api\TransactionRepositoryInterface
{
	/**
     * @var \Customweb\BarclaycardCw\Model\Authorization\TransactionRegistry
     */
    ...
    /**
     * @var \Customweb\BarclaycardCw\Api\Data\TransactionInterfaceFactory
     */
	...
	/**
	 * @param \Customweb\BarclaycardCw\Model\Authorization\TransactionRegistry $transactionRegistry
	 * @param \Customweb\BarclaycardCw\Model\Authorization\TransactionFactory $transactionFactory
	 * @param \Customweb\BarclaycardCw\Api\Data\TransactionInterfaceFactory $transactionDataFactory
	 * @param \Magento\Customer\Api\Data\CustomerSearchResultsInterfaceFactory $searchResultsFactory
	 * @param \Magento\Framework\Api\DataObjectHelper $dataObjectHelper
	 */
	public function __construct(
			\Customweb\BarclaycardCw\Model\Authorization\TransactionRegistry $transactionRegistry,
			\Customweb\BarclaycardCw\Model\Authorization\TransactionFactory $transactionFactory,
			\Customweb\BarclaycardCw\Api\Data\TransactionInterfaceFactory $transactionDataFactory,
	...
	public function getList(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria)
	{
		...
		/** @var \Customweb\BarclaycardCw\Model\ResourceModel\Authorization\Transaction\Collection $collection */
	 ...
	 *
	 * @return \Customweb\BarclaycardCw\Api\Data\TransactionInterface
	 */
	protected function getDataModel(\Customweb\BarclaycardCw\Model\Authorization\Transaction $transaction)
	{
		$transactionDataObject = $this->_transactionDataFactory->create();
		$this->_dataObjectHelper->populateWithArray(
				$transactionDataObject,
				$this->extractTransactionData($transaction),
				'\Customweb\BarclaycardCw\Api\Data\TransactionInterface'
		);
		return $transactionDataObject;
	}

	private function extractTransactionData(\Customweb\BarclaycardCw\Model\Authorization\Transaction $transaction)
	{
		...
		$data[\Customweb\BarclaycardCw\Api\Data\TransactionInterface::TRANSACTION_DATA] = $transactionData;
		return $data;
	}
