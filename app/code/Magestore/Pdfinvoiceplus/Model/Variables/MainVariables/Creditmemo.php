 ...
 */
class Creditmemo extends \Magestore\Pdfinvoiceplus\Model\Variables\AbstractMainVariables
{
    /**
     * @var array
     */
    ...
    {
        return $this->_optionManager->get(OptionManager::OPTION_VARIABLE_CONFIG_CREDITMEMO)->toOptionArray();
    }
}