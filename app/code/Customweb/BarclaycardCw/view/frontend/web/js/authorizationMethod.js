	...
	var AuthorizationMethod = function(formElement, authorizationUrl) {
		...
		this.redirect = function(orderId) {
			...
			if (!customer.isLoggedIn()) {
				serviceUrl = urlBuilder.createUrl('/guest-carts/:cartId/barclaycardcw/checkout/authorize', {
					cartId: quote.getQuoteId()
				});
			} else {
				serviceUrl = urlBuilder.createUrl('/carts/mine/barclaycardcw/checkout/authorize', {});
			}
			return storage.post(
