 ...
 */
class InvoiceItem extends \Magestore\Pdfinvoiceplus\Model\Variables\Option\AbstractVariableConfig
{
    /**
     * @return string
     */
    ...
    {
        return self::XML_PATH_VARIABLES_INVOICE_ITEM;
    }
    ...
    {
        return $this->_optionManager->get(OptionManager::OPTION_VARIABLE_INVOICE_ITEM);
    }
}