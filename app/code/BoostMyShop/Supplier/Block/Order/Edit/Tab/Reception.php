...
class Reception extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('por_created_at', ['filter' => false, 'sortable' => false, 'align' => 'center', 'header' => __('Date'), 'index' => 'por_created_at', 'type' => 'datetime']);
        $this->addColumn('por_username', ['filter' => false, 'sortable' => false, 'align' => 'center', 'header' => __('User'), 'index' => 'por_username', 'type' => 'text']);
        $this->addColumn('por_product_count', ['filter' => false, 'sortable' => false, 'align' => 'center', 'header' => __('Products received'), 'index' => 'por_product_count', 'type' => 'text']);
