...
namespace Customweb\BarclaycardCw\Model\ResourceModel\Authorization;

class Transaction extends \Customweb\BarclaycardCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_barclaycardcw_transaction_resource';
	...
	public function unserializeTransactionObject(\Customweb\BarclaycardCw\Model\Authorization\Transaction $transaction){
    ...
    {
        $this->_init('customweb_barclaycardcw_transaction', 'entity_id');
    }
