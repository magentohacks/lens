...
class AdditionPrescriptions implements \Magento\Framework\Data\OptionSourceInterface
{
    public $helper;
    ...
    public function toOptionArray()
    {
         ...
         */
        $options = [];
        if ($this->helper->getAdditionValue()) {
            $axisPrescriptions = explode(',', $this->helper->getAdditionValue());
