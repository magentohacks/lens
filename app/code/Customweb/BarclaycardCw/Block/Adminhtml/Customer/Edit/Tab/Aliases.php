...
namespace Customweb\BarclaycardCw\Block\Adminhtml\Customer\Edit\Tab;
...
class Aliases extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Ui\Component\Layout\Tabs\TabInterface
{
    ...
    /**
     * @var \Customweb\BarclaycardCw\Model\ResourceModel\Grid\PaymentMethodList
     */
     ...
     * @param \Customweb\BarclaycardCw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList
    ...
    public function __construct(
    		...
    		\Customweb\BarclaycardCw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList,
    ...
    {
    	parent::_construct();
    	$this->setId('barclaycardcw_customer_alias_grid');
    ...
    {
    	return $this->getUrl('barclaycardcw/customer/aliases', ['_current' => true]);
    }
