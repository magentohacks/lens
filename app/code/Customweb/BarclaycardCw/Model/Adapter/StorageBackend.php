...
class StorageBackend implements \Customweb_Storage_IBackend
{
	 ...
	 *
	 * @var \Customweb\BarclaycardCw\Model\StorageFactory
	 */
	protected $_storageFactory;

	public function __construct(
			\Customweb\BarclaycardCw\Model\StorageFactory $storageFactory
	) {
	...
	/**
	 * @return \Customweb\BarclaycardCw\Model\Storage
	 */
