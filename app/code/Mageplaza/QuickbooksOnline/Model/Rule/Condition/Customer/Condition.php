 ...
 */
namespace Mageplaza\QuickbooksOnline\Model\Rule\Condition\Customer;
...
/**
 * Class Condition
 * @package Mageplaza\QuickbooksOnline\Model\Rule\Condition\Customer
 */
class Condition extends AbstractCondition
{
    ...
    {
        return is_object($this->getAttributeObject()) && $this->getAttributeObject()->getFrontendInput() === 'date';
    }
    ...
    public function validate(AbstractModel $model)
    {
        if ($this->getAttribute() === 'created_at') {
            $model->setCreatedAt($this->formatDate($model->getCreatedAt()));
        }
