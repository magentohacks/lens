...
namespace Customweb\BarclaycardCw\Controller\ExternalCheckout;

class RegisterPost extends \Customweb\BarclaycardCw\Controller\ExternalCheckout
{
	/**
	...
	{
		if (!($this->getContext() instanceof \Customweb\BarclaycardCw\Model\ExternalCheckout\Context) || !$this->getContext()->getId()) {
		...
		if ($this->getRequest()->isPost()) {
			$this->getContext()->setRegisterMethod(\Customweb\BarclaycardCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER);
			...
			if (true !== ($result = $this->_helper->validateCustomerData($this->getQuote(), $data, \Customweb\BarclaycardCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER))) {
