...
class CylinderPrescriptions implements \Magento\Framework\Data\OptionSourceInterface
{
    public $helper;
    ...
    public function toOptionArray()
    {
         ...
         */
        $options = [];
        if ($this->helper->getCylinderValue()) {
            $axisPrescriptions = explode(',', $this->helper->getCylinderValue());
