...
class TransactionHandler implements \Customweb_Payment_ITransactionHandler
{
	 ...
	 * @param mixed $value
	 * @param string $field
	 * @return null|\Customweb\BarclaycardCw\Model\Authorization\Transaction
	 */
	 ...
	 */
	private function storeInCache(\Customweb\BarclaycardCw\Model\Authorization\Transaction $transaction)
	{
