...
class FrontendForm extends AbstractForm
{
	...
	{
		parent::__construct();
		$this->setControlCssClassResolver(new \Customweb\BarclaycardCw\Model\Renderer\ControlCssClassResolver());
	}

	public function renderElementGroupPrefix(\Customweb_Form_IElementGroup $elementGroup)
	{
		return '<fieldset class="barclaycardcw_fieldset fieldset">';
	}
