 ...
 */
namespace Magiccart\Campaignbar\Block\System\Config\Form\Field;

use Magiccart\Campaignbar\Model\Status;
/**
...
class Display extends \Magento\Config\Block\System\Config\Form\Field\FieldArray\AbstractFieldArray
{
     ...
     * @param \Magiccart\Campaignbar\Model\System\Config\Block $bock
     * @param array $data
     */
    ...
    protected function _getEnabledRenderer($defaulValue='1')
    {
        ...
        if (!$this->_enabledRenderer) {
            $this->_enabledRenderer = $this->getLayout()->createBlock(
                \Magiccart\Campaignbar\Block\System\Config\Form\Field\Yesno::class,
                '',
