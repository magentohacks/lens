 ...
 */
class AdvanceEdit extends \Magestore\Pdfinvoiceplus\Controller\Adminhtml\Design
{
    /**
     * Dispatch request
     *
    ...
    public function execute()
    {
        ...
        $block = $resultLayout->getLayout()->createBlock('Magestore\Pdfinvoiceplus\Block\Adminhtml\Design\Editor\AdvanceEdit');
