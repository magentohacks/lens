...
namespace Customweb\BarclaycardCw\Block\Adminhtml\Config;
...
class Form extends \Magento\Backend\Block\Widget
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_BarclaycardCw::barclaycardcw/config/form.phtml';

	/**
	 * @var \Customweb\BarclaycardCw\Model\Config\Structure
	 */
	protected $_formStructure;

	/**
	 * @var \Customweb\BarclaycardCw\Model\Renderer\Adminhtml\BackendForm
	 */
	protected $_backendFormRenderer;

	/**
	 * @param \Magento\Backend\Block\Template\Context $context
	 * @param \Customweb\BarclaycardCw\Model\Config\Structure $formStructure,
	 * @param \Customweb\BarclaycardCw\Model\Renderer\Adminhtml\BackendForm $backendFormRenderer
	 * @param array $data
	 */
	public function __construct(
			\Magento\Backend\Block\Template\Context $context,
			\Customweb\BarclaycardCw\Model\Config\Structure $formStructure,
			\Customweb\BarclaycardCw\Model\Renderer\Adminhtml\BackendForm $backendFormRenderer,
			array $data = []
	) {
