    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!$installer->tableExists('mageplaza_reward_rate')) {
            $table = $installer->getConnection()
                ...
                ->addColumn('rate_id', Table::TYPE_INTEGER, null, ['identity' => true, 'nullable' => false, 'primary' => true, 'unsigned' => true], 'Template Id')
                ...
                ->addColumn('direction', Table::TYPE_SMALLINT, null, ['unsigned' => true, 'default' => '1'], 'Direction')
        ...
        if (!$installer->tableExists('mageplaza_reward_customer')) {
            $table = $installer->getConnection()
                ...
                ->addColumn('reward_id', Table::TYPE_INTEGER, null, ['identity' => true, 'nullable' => false, 'primary' => true, 'unsigned' => true], 'Reward Id')
                ...
                ->addColumn('notification_update', Table::TYPE_BOOLEAN, null, ['nullable' => false, 'default' => 0], 'Notification Update')
                ->addColumn('notification_expire', Table::TYPE_BOOLEAN, null, ['nullable' => false, 'default' => 0], 'Notification Expire')
                ->addForeignKey(
        ...
        if (!$installer->tableExists('mageplaza_reward_transaction')) {
            $table = $installer->getConnection()
                ...
                ->addColumn('transaction_id', Table::TYPE_INTEGER, null, ['identity' => true, 'nullable' => false, 'primary' => true, 'unsigned' => true], 'Reward Id')
                ->addColumn('reward_id', Table::TYPE_INTEGER, null, ['unsigned' => true, 'nullable' => false], 'Reward Id')
                ...
                ->addColumn('action_type', Table::TYPE_SMALLINT, null, ['nullable' => false, 'default' => '0'], 'Action Type')
                ...
                ->addColumn('expiration_date', Table::TYPE_TIMESTAMP, null, ['default' => Table::TIMESTAMP_INIT], 'Expiration Date')
                ...
                ->addColumn('lock_changed_date', Table::TYPE_TIMESTAMP, null, ['nullable' => false, 'default' => Table::TIMESTAMP_INIT], 'lock_changed_date')
                ->addColumn('notification_email', Table::TYPE_TIMESTAMP, null, ['nullable' => false, 'default' => Table::TIMESTAMP_INIT], 'notification_email')
                ->addColumn('comment', Table::TYPE_TEXT, 255, ['nullable' => false], 'Notice')
                ->addColumn('notice', Table::TYPE_TEXT, 255, [], 'Notice')
                ->addForeignKey(
                    $installer->getFkName('mageplaza_reward_transaction', 'reward_id', 'mageplaza_reward_customer', 'reward_id'),
                    'reward_id',
