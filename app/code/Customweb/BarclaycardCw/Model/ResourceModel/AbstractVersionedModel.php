...
namespace Customweb\BarclaycardCw\Model\ResourceModel;
		...
		*/
		if ($this->_isPkAutoIncrement) {
			...
			if (!empty($data)) {
				...
				if($rowAffected == 0) {
					throw new \Customweb\BarclaycardCw\Model\Exception\OptimisticLockingException(get_class($object), $object->getId());
				}
