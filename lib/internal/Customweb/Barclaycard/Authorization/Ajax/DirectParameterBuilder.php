...
class Customweb_Barclaycard_Authorization_Ajax_DirectParameterBuilder extends Customweb_Barclaycard_Authorization_AbstractAuthorizationParameterBuilder {
	...
	protected function getAliasManagerParameters(){
		...
		$store = 'N';
		if(isset( $this->formData['ALIAS_STOREPERMANENTLY']) &&  strtoupper($this->formData['ALIAS_STOREPERMANENTLY']) == 'Y'){
			$store = 'Y';
		}
		$parameters['ALIASPERSISTEDAFTERUSE'] = $store;
