...
abstract class AbstractContext implements IContext
{
	...
	/**
	 * @var \Customweb\BarclaycardCw\Model\Authorization\CustomerContext
	 */
	...
	{
		if (!($this->customerContext instanceof \Customweb\BarclaycardCw\Model\Authorization\CustomerContext)) {
