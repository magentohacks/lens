...
class Condition extends Generic implements TabInterface
{
    ...
    protected function addTabToForm($model, $fieldsetId = 'conditions_fieldset', $formName = 'sync_rule_form')
    {
        ...
        $newChildUrl = $this->getUrl(
            'mpquickbooks/condition/newConditionHtml/form/' . $conditionsFieldSetId,
        ...
        $fieldset = $form->addFieldset(
            $fieldsetId,
            ['legend' => __('Conditions (don\'t add conditions if rule is applied to all objects)')]
    ...
    {
        return $this->getUrl('mpquickbooks/sync/condition', ['_current' => true]);
    }
