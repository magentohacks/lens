...
namespace Customweb\BarclaycardCw\Plugin\Framework\App;

class Http
{

	/**
	 * @var \Customweb\BarclaycardCw\Model\Logging\Listener
	 */
	private $_loggingListener;

	/**
	 * @param \Customweb\BarclaycardCw\Model\Logging\Listener $loggingListener
	 */
	public function __construct(
			\Customweb\BarclaycardCw\Model\Logging\Listener $loggingListener
	) {
	...
	{
		\Customweb_I18n_Translation::getInstance()->addResolver(new \Customweb\BarclaycardCw\Model\TranslationResolver());
	}
