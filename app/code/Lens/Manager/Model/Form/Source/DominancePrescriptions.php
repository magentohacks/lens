...
class DominancePrescriptions implements \Magento\Framework\Data\OptionSourceInterface
{
    public $helper;
    ...
    public function toOptionArray()
    {
         ...
         */
        $options = [];
        if ($this->helper->getDominanceValue()) {
            $axisPrescriptions = explode(',', $this->helper->getDominanceValue());
