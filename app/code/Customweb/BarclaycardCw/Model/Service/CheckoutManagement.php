...
class CheckoutManagement implements \Customweb\BarclaycardCw\Api\CheckoutManagementInterface
{
	/**
	...
	/**
	 *
	 * @var \Customweb\BarclaycardCw\Model\Payment\Method\ConfigProvider
	 */
	 ...
	 * @param \Customweb\BarclaycardCw\Model\Payment\Method\ConfigProvider $configProvider
	...
	public function __construct(
		...
		\Customweb\BarclaycardCw\Model\Payment\Method\ConfigProvider $configProvider,
     ...
     * @param int $alias
     * @return string
     * @throws \Customweb\BarclaycardCw\Model\Exception\OptimisticLockingException
     */
    protected function buildPaymentForm($quoteId, $paymentMethod, $alias = null)
    {
	    	...
	    	for ($i = 0; $i < 10; $i++) {
	    		...
	    		catch (\Customweb\BarclaycardCw\Model\Exception\OptimisticLockingException $e) {
	    			// Try again.
	    			$lastException = $e;
	    		}
	    	}
    ...
    /**
     *
     * @param \Customweb\BarclaycardCw\Api\Data\AuthorizationFormFieldInterface[] $formValues
     * @return NULL|string[]
     */
    protected function convertFormValuesToMap(array $formValues = null) {
    		...
    		foreach ($formValues as $formValue) {
    			/* @var \Customweb\BarclaycardCw\Api\Data\AuthorizationFormFieldInterface $formValue */
