 ...
 */
class CreditmemoItem extends \Magestore\Pdfinvoiceplus\Model\Variables\Option\AbstractVariableConfig
{
    /**
     * @return string
     */
    ...
    {
        return self::XML_PATH_VARIABLES_CREDITMEMO_ITEM;
    }
    ...
    {
        return $this->_optionManager->get(OptionManager::OPTION_VARIABLE_CREDITMEMO_ITEM);
    }
}