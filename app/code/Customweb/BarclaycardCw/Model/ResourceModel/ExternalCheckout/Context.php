...
namespace Customweb\BarclaycardCw\Model\ResourceModel\ExternalCheckout;

class Context extends \Customweb\BarclaycardCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_barclaycardcw_external_checkout_context_resource';
    ...
    {
        $this->_init('customweb_barclaycardcw_external_checkout_context', 'context_id');
    }
