...
namespace Customweb\BarclaycardCw\Block\Adminhtml\Transaction;
...
class View extends \Magento\Backend\Block\Widget\Form\Container
{
	...
	protected function _construct()
	{
		...
		$this->setId('barclaycardcw_transaction_view');
	...
	{
		return $this->_coreRegistry->registry('barclaycardcw_transaction');
	}
	...
	{
		return $this->getUrl('barclaycardcw/transaction/update');
	}
	...
	public function getBackUrl()
	{
		...
		return $this->getUrl('barclaycardcw/transaction/');
	}
}