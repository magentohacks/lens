 ...
 */
class QuoteTableItem extends \Magestore\Pdfinvoiceplus\Block\Adminhtml\AbstractTemplateInformation
{
    const COLUMN_PRODUCT = '{{var items_name}}';
