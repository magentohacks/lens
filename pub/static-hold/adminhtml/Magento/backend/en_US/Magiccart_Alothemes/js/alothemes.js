	...
	'jquery',
		...
		jQuery(document).ready(function($){
			...
			*/
			...
			var color = '#row_alodesign_root_color, #row_alodesign_base_color, #row_alodesign_header_color, #row_alodesign_left_color, #row_alodesign_right_color, #row_alodesign_content_color, #row_alodesign_footer_color, #row_alodesign_custom_color';
