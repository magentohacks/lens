...
class InstallData implements InstallDataInterface
{
    ...
    {
        $sql = 'INSERT INTO `' . $setup->getTable('bms_advancedstock_warehouse_item') . '` (wi_warehouse_id, wi_product_id, wi_physical_quantity, wi_available_quantity) ';
        $sql .= 'select distinct 1, product_id, qty, qty from `' . $setup->getTable('cataloginventory_stock_item') . '` ';
    ...
    {
        $sql = 'INSERT INTO `' . $setup->getTable('bms_advancedstock_stock_movement') . '` (sm_created_at, sm_product_id, sm_from_warehouse_id, sm_to_warehouse_id, sm_qty, sm_category, sm_comments) ';
    ...
    {
        $sql = 'INSERT INTO `' . $setup->getTable('bms_advancedstock_extended_sales_flat_order_item') . '` (esfoi_order_item_id, esfoi_warehouse_id, esfoi_qty_reserved, esfoi_qty_to_ship) ';
