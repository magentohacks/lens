...
namespace Customweb\BarclaycardCw\Model\ExternalCheckout\Widget;
		...
		for ($i = 0; $i < 10; $i++) {
			try {
				...
				if ($quote instanceof \Magento\Quote\Model\Quote && $quote->getId() && $quote->hasItems()) {
					/* @var $context \Customweb\BarclaycardCw\Model\ExternalCheckout\Context */
					...
					foreach ($checkouts as $checkout) {
						$widgets[] = new \Customweb\BarclaycardCw\Model\ExternalCheckout\Widget($checkout, $providerService->getWidgetHtml($checkout, $context));
					}
