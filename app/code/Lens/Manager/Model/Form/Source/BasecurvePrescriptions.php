...
class BasecurvePrescriptions implements \Magento\Framework\Data\OptionSourceInterface
{
    public $helper;
    ...
    public function toOptionArray()
    {
         ...
         */
        $options = [];
        if ($this->helper->getBasecurveValue()) {
            $axisPrescriptions = explode(',', $this->helper->getBasecurveValue());
