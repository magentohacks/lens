...
class Tab extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    protected function _prepareCollection()
    {
        ...
        //$collection->addAttributeToSelect('customer_name');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('shipping_description', ['header' => __('Shipping method'), 'index' => 'shipping_description']);
        $this->addColumn('products', ['header' => __('Products'), 'index' => 'index_id', 'renderer' => '\BoostMyShop\OrderPreparation\Block\Preparation\Renderer\Products']);
