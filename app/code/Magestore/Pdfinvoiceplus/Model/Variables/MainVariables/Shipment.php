 ...
 */
class Shipment extends \Magestore\Pdfinvoiceplus\Model\Variables\AbstractMainVariables
{
    /**
     * @var array
     */
    ...
    {
        return AbstractVariableOption::PREFIX_VAR_SHIPMENT;
    }
    ...
    {
        return $this->_optionManager->get(OptionManager::OPTION_VARIABLE_CONFIG_SHIPMENT)->toOptionArray();
    }
}