 ...
 *
 */
namespace Customweb\BarclaycardCw\Model\Payment\Method;
...
class AbstractMethod extends \Magento\Payment\Model\Method\AbstractMethod implements \Customweb_Payment_Authorization_IPaymentMethod
{
	...
	/**
	 *
	 * @var \Customweb\BarclaycardCw\Model\Configuration
	 */
	 ...
	 * @var string
	 */
	protected $_formBlockType = 'Customweb\BarclaycardCw\Block\Payment\Method\Form';
	 ...
	 * @var string
	 */
	protected $_infoBlockType = 'Customweb\BarclaycardCw\Block\Payment\Method\Info';
	 ...
	 * @param \Customweb\BarclaycardCw\Model\Configuration $configuration
	...
	public function __construct(
			...
			\Customweb\BarclaycardCw\Model\Configuration $configuration,
	...
	public function getOrderPlaceRedirectUrl()
	{
		...
		$transactionId = null;
		$transaction = $this->_registry->registry('barclaycardcw_transaction');
		if ($transaction instanceof \Customweb\BarclaycardCw\Model\Authorization\Transaction) {
			$transactionId = $transaction->getId();
		}
		return $quote->getStore()->getUrl('barclaycardcw/checkout/error', [
			'_secure' => true,
	...
	public function validate()
	{
		...
		$arguments = null;
		return \Customweb_Licensing_BarclaycardCw_License::run('6jl02uteu6tsmk5l', $this, $arguments);
	}

	final public function call_amvn37fo11o4eftq() {
	 ...
	 * @return \Customweb\BarclaycardCw\Model\Payment\Method\AbstractMethod
	 */
	...
	public function authorize(\Magento\Payment\Model\InfoInterface $payment, $amount)
	{
		...
		$transaction = $this->_registry->registry('barclaycardcw_authorization_transaction');
		if ($transaction instanceof \Customweb\BarclaycardCw\Model\Authorization\Transaction) {
	...
	public function capture(\Magento\Payment\Model\InfoInterface $payment, $amount)
	{
		...
		try {
			...
			if ($transaction->getId()) {
				$invoice = $this->_registry->registry('barclaycardcw_invoice');
	...
	private function captureItems(\Customweb\BarclaycardCw\Model\Authorization\Transaction $transaction, $items = [])
	{
