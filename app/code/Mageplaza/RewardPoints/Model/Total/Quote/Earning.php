...
class Earning extends AbstractTotal
{
    ...
    )
    {
        ...
        $this->calculation->resetRewardData($items, $quote, ['mp_reward_earn', 'mp_reward_shipping_earn'], ['mp_reward_earn']);
    ...
    {
        if ($this->helperData->isEnabled($quote->getStoreId()) && $quote->getMpRewardEarn() > 0) {
