...
class Login extends AbstractExternalCheckout
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_BarclaycardCw::externalcheckout/login.phtml';
	...
	{
		return $this->getUrl('barclaycardcw/externalCheckout/loginPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('barclaycardcw/externalCheckout/guestPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('barclaycardcw/externalCheckout/registerPost', ['_secure' => true]);
	}
