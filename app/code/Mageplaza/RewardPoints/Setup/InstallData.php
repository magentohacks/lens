    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        foreach ($data as $item) {
            if (in_array($item['table'], ['quote', 'quote_item', 'quote_address'])) {
                $quoteInstaller->addAttribute($item['table'], $item['column'], ['type' => Table::TYPE_DECIMAL, 'visible' => false]);
            } else {
                $salesInstaller->addAttribute($item['table'], $item['column'], ['type' => Table::TYPE_DECIMAL, 'visible' => false]);
            }
        }
    }
}