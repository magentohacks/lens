...
class Calculation
{
     ...
     * @return mixed
     */
    public function aroundGetSpendingConfiguration(\Mageplaza\RewardPoints\Helper\Calculation $helperCalculation, \Closure $proceed, $quote)
    {
        ...
        foreach ($spendingRules as $rule) {
            ...
            if ($total) {
                ...
                if ($maxSpending) {
                    ...
                    $spendingConfig['rules'][] = $this->getRuleConfig($rule->getId(), $label, $maxSpending, $isDisplaySlider);
                }
            }
        }
