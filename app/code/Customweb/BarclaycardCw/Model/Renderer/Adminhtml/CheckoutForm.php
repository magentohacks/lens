...
namespace Customweb\BarclaycardCw\Model\Renderer\Adminhtml;

class CheckoutForm extends \Customweb\BarclaycardCw\Model\Renderer\AbstractForm
{
	/**
	...
	public function __construct(
		...
		$this->setControlCssClassResolver(new \Customweb\BarclaycardCw\Model\Renderer\Adminhtml\ControlCssClassResolver());

		$this->setFormCssClass('barclaycardcw_form');
