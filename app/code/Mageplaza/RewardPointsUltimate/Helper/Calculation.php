...
class Calculation extends HelperCalculation
{
    ...
    )
    {
        ...
        parent::__construct($context, $objectManager, $storeManager, $priceCurrency, $timeZone, $calculatorFactory, $transactionFactory);
    }
     ...
     * @return null
     */
    public function calculateItem($item, $totalReferer, $totalCustomer, $totalRefererEarn, $totalCustomerEarn, &$mpCustomerEarn, &$mpRefererEarn, &$lastItem)
    {
    ...
    public function getCustomerPointsByAction($total, $rule)
    {
        ...
        } else if ($rule->getCustomerAction() == CustomerActions::TYPE_FIXED_POINTS) {
