...
class Factory
{
     ...
     * @return \Customweb\BarclaycardCw\Model\Authorization\Method\AbstractMethod
     */
    public function create(\Customweb\BarclaycardCw\Model\Authorization\Method\Context\IContext $context)
    {
    	if ($context->isMoto()) {
    ...
    /**
     * @param \Customweb\BarclaycardCw\Model\Authorization\Method\Context\IContext $context
     * @return \Customweb\BarclaycardCw\Model\Authorization\Method\Moto
     */
    public function createMoto(\Customweb\BarclaycardCw\Model\Authorization\Method\Context\IContext $context)
    {
    	return $this->_objectManager->create('\\Customweb\\BarclaycardCw\\Model\\Authorization\\Method\\Moto', ['context' => $context]);
    }

    /**
     * @return \Customweb\BarclaycardCw\Model\Authorization\Method\Context\Factory
     */
