...
class Service implements \Customweb_Payment_ExternalCheckout_ICheckoutService
{
	...
	/**
	 * @var \Customweb\BarclaycardCw\Model\ExternalCheckout\ContextFactory
	 */
	protected $_contextFactory;

	/**
	 * @var \Customweb\BarclaycardCw\Helper\ExternalCheckout
	 */
	protected $_helper;
	...
	/**
	 * @var \Customweb\BarclaycardCw\Model\Authorization\OrderContextFactory
	 */
	 ...
	 * @param \Customweb\BarclaycardCw\Model\ExternalCheckout\ContextFactory $contextFactory
	 * @param \Customweb\BarclaycardCw\Helper\ExternalCheckout $helper
	...
	public function __construct(
			...
			\Customweb\BarclaycardCw\Model\ExternalCheckout\ContextFactory $contextFactory,
			\Customweb\BarclaycardCw\Helper\ExternalCheckout $helper,
	...
	/**
	 * @param \Customweb\BarclaycardCw\Model\DependencyContainer $container
	 * @return \Customweb\BarclaycardCw\Model\ExternalCheckout\Service
	 */
	public function setContainer(\Customweb\BarclaycardCw\Model\DependencyContainer $container)
	{
	...
	{
		if (!($context instanceof \Customweb\BarclaycardCw\Model\ExternalCheckout\Context)) {
			throw new \Customweb_Core_Exception_CastException('Customweb\BarclaycardCw\Model\ExternalCheckout\Context');
		}
	...
	public function authenticate(\Customweb_Payment_ExternalCheckout_IContext $context, $emailAddress, $successUrl)
	{
		...
		if ($this->_checkoutHelper->isAllowedGuestCheckout($context->getQuote())
				&& $this->_scopeConfig->getValue('barclaycardcw/shop/external_checkout_account_creation') == 'skip_selection') {
			...
			$context->setRegisterMethod(\Customweb\BarclaycardCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST);
		...
		$context->save();
		return \Customweb_Core_Http_Response::redirect($context->getQuote()->getStore()->getUrl('barclaycardcw/externalCheckout/login', ['_secure' => true]));
	}
	...
	public function renderShippingMethodSelectionPane(\Customweb_Payment_ExternalCheckout_IContext $context, $errorMessages)
	{
		...
		return $this->_layoutFactory->create()->createBlock('Customweb\BarclaycardCw\Block\ExternalCheckout\ShippingMethods')
			->setContext($context)
	...
	public function renderReviewPane(\Customweb_Payment_ExternalCheckout_IContext $context, $renderConfirmationFormElements, $errorMessage)
	{
		...
		$layout->getUpdate()->load(['barclaycardcw_externalcheckout_review']);
		$layout->generateXml();
		$layout->generateElements();
		$layout->getBlock('customweb_barclaycardcw_externalcheckout_review')
			->setContext($context)
	...
	public function createOrder(\Customweb_Payment_ExternalCheckout_IContext $context)
	{
		...
		try {
			...
			/* @var $transaction \Customweb\BarclaycardCw\Model\Authorization\Transaction */
			$transaction = $this->_coreRegistry->registry('barclaycardcw_transaction');
