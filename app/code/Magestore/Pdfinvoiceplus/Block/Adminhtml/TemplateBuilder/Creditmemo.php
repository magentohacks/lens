 ...
 */
class Creditmemo extends \Magestore\Pdfinvoiceplus\Block\Adminhtml\AbstractTemplateBuilder
{
    /**
     * @var string
     */
    protected $_builderType = 'creditmemo';

    /**
     * @var string
     */
    protected $_tableItemsTemplate = 'Magestore_Pdfinvoiceplus::default-template/table-items/creditmemo.phtml';
    ...
    {
        return $this->getPdfTemplateObject()->getData('barcode_creditmemo');
    }
