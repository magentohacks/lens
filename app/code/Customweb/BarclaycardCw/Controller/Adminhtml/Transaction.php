...
namespace Customweb\BarclaycardCw\Controller\Adminhtml;
...
abstract class Transaction extends \Magento\Backend\App\Action
{
	...
	protected function _initAction()
	{
		...
		$resultPage->setActiveMenu('Customweb_BarclaycardCw::transactions');
		$resultPage->addBreadcrumb(__('Sales'), __('Sales'));
		$resultPage->addBreadcrumb('Barclaycard', 'Barclaycard');
		$resultPage->addBreadcrumb(__('Barclaycard Transactions'), __('Barclaycard Transactions'));
		return $resultPage;
	}
	 ...
	 *
	 * @return \Customweb\BarclaycardCw\Model\Authorization\Transaction|false
	 */
	protected function _initTransaction()
	{
		...
		$this->_coreRegistry->register('barclaycardcw_transaction', $transaction);
		return $transaction;
	}

	protected function _isAllowed()
	{
		return $this->_authorization->isAllowed('Customweb_BarclaycardCw::transactions');
	}
}