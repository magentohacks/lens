...
class Iframe extends \Customweb\BarclaycardCw\Controller\Checkout
{
	public function execute()
	{
		$context = $this->_authorizationMethodFactory->getContextFactory()->createTransaction();
		/* @var $authorizationMethodAdapter \Customweb\BarclaycardCw\Model\Authorization\Method\Iframe */
		...
		$resultPage->getLayout()
			->getBlock('customweb_barclaycardcwcheckout_iframe')
