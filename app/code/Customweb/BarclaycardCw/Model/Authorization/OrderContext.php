...
class OrderContext implements \Customweb_Payment_Authorization_IOrderContext
{
	 ...
	 * @param \Customweb\BarclaycardCw\Model\Payment\Method\AbstractMethod|string $paymentMethod
	 * @throws \Exception
	 */
	...
	private function assembleDataFromQuote(
		...
		$checkoutId = $checkoutSession->getBarclaycardCwCheckoutId();
		if(empty($checkoutId)){
			$checkoutId = \Customweb_Core_Util_Rand::getUuid();
			$checkoutSession->setBarclaycardCwCheckoutId($checkoutId);
		}
