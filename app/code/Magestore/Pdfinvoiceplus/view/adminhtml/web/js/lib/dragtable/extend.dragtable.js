...
define([
    ...
    var dragtable = {
        ...
        eventPosition: function (event) {
            var x, y;
            if (dragtable.browser && dragtable.browser.isIE) {
        ...
        absolutePosition: function (elt, stopAtRelative) {
            var ex = 0, ey = 0;
            do {
                var curStyle = (dragtable.browser && dragtable.browser.isIE) ? elt.currentStyle
                    : window.getComputedStyle(elt, '');
                var supportFixed = !(dragtable.browser && dragtable.browser.isIE &&
