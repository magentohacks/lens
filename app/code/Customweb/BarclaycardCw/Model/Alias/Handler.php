...
namespace Customweb\BarclaycardCw\Model\Alias;

class Handler
{
	/**
	 * @var \Customweb\BarclaycardCw\Model\ResourceModel\Authorization\Transaction\Collection
	 */
	 ...
	 */
	public function getAliasTransactions(\Customweb\BarclaycardCw\Model\Authorization\OrderContext $orderContext)
	{
	 ...
	 */
	public function removeSimilarAliases(\Customweb\BarclaycardCw\Model\Authorization\Transaction $transaction)
	{
	 ...
	 * @throws \Exception
	 */
	public function removeAlias(\Customweb\BarclaycardCw\Model\Authorization\Transaction $transaction)
	{
	 ...
	 * @throws Exception
	 */
	public function deactivateAlias(\Customweb\BarclaycardCw\Model\Authorization\Transaction $transaction)
	{
		$transaction->setAliasActive(false);
		$transaction->save();
	}
